                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-header">
                            <h5 class="card-title mb-0">Update Picture Details</h5>
                        </div>
                        <!--end::Card Header-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <select name="type" class="form-control" required>
                                                    <option value="gallery" {{$picture->type == 'gallery' ? 'selected' : ''}}>Gallery</option>
                                                    <option value="banner" {{$picture->type == 'banner' ? 'selected' : ''}}>Banner</option>
                                                </select>
                                            </div>
